<div class="topnav"
    ...
    <ul class="topnav__ul">
        <li>Apply <img src="<?php echo get_template_directory_uri() . '/public/SVGs/arrow.svg' ?>" alt="Arrow"
                height="16"></li>
        <li style="color: #be8723;">Donate <img
                src="<?php echo get_template_directory_uri() . '/public/SVGs/arrow.svg' ?>" alt="Arrow" height="16">
        </li>
    </ul>
</div>