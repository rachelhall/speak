...
<div <?php tribe_classes( $container_classes ); ?> data-js="tribe-events-view"
    ...
    <div class="hero calendar-hero"
        style="background-image: url('<?php echo get_template_directory_uri() . '/public/images/teacher-classroom.jpg' ?>')">
        <div class="hero__screen"></div>
        <div class="calendar-hero__copy">
            <div class="hero__copy--bold">
                <p class="hero-heading">Calendar</p>
            </div>
...
<div class="tribe-common-l-container tribe-events-l-container ">
    ...
    <div class="manup-events-container">
        ...
        <div class="tribe-events-calendar-list calendar-grid">
